...
namespace exercicio_while
{
    internal class Program
    {
        ...
        {
            int idade, identidadeDeGenero = 0, Naobinario = 0, pessoaDesenvolvedora = 0;
            int backend = 0, mulheresFront = 0,homemM40 = 0, naoBim30 = 0, total =0,media = 0,somaDasIdades = 0;
            string? continua = "S";
            ...
            while (continua == "S")
            {
                ...
                if ((identidadeDeGenero == 2 || identidadeDeGenero == 5) && pessoaDesenvolvedora == 3)
                {
                    homemM40++;
                }
                if(identidadeDeGenero == 3 && pessoaDesenvolvedora == 4)
                {
                    naoBim30++;
                }
