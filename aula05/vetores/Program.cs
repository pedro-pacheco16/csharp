namespace vetores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] vetor03 = { "Allan", "Ingrid", "joão", "Gabriel", "Shomara", "Karina" };
            ...
            Console.WriteLine("Qual a posição da ingrid no vetor:" + Array.IndexOf(vetor03,"ingrid"));

            Console.WriteLine("Qual a posição da ingrid no vetor:" + Array.BinarySearch(vetor03, "ingrid"));
